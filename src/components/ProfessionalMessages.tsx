            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800/60">
              {filteredConversations.map(conv => (
                <div 
                  ...
                  className={`p-4 cursor-pointer transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50 ${selectedCustomerId === conv.customerId ? 'bg-navy-50 dark:bg-navy-900/20' : ''}`}
                >
                  <div className="flex gap-3">
                    <div className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-800 flex items-center justify-center shrink-0 text-slate-500 dark:text-slate-400 font-bold text-sm">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {conv.relatedBooking && (
                        <div className="text-[10px] font-semibold text-navy-600 dark:text-navy-400 mb-1 truncate">
