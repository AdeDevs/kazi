...
export const ProProfileManagement: React.FC<ProProfileManagementProps> = ({
  ...
  return (
    <div className="w-full max-w-none space-y-4 animate-in fade-in">
      ...
      {/* 1. PRIMARY ARTISAN IDENTITY CARD (Padding: 15px / p-[15px]) */}
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-[15px] border border-slate-200 dark:border-slate-800 shadow-xs space-y-3.5">
      ...
      {/* 3. SERVICES & PRICING (Padding: 15px / p-[15px]) */}
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-[15px] border border-slate-200 dark:border-slate-800 shadow-xs space-y-3.5">
        <div className="flex items-center justify-between gap-2.5 pb-2.5 border-b border-slate-100 dark:border-slate-800">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              <h2 className="font-black text-sm sm:text-base text-slate-900 dark:text-slate-100 truncate">Services & Pricing</h2>
            ...
            <p className="text-[11px] text-slate-500 truncate sm:whitespace-normal">Fixed rates, starting prices, and custom quotes.</p>
          </div>
      ...
      {/* 4. WORK PORTFOLIO (Padding: 15px / p-[15px]) */}
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-[15px] border border-slate-200 dark:border-slate-800 shadow-xs space-y-3.5">
        <div className="flex items-center justify-between gap-2.5 pb-2.5 border-b border-slate-100 dark:border-slate-800">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              <h2 className="font-black text-sm sm:text-base text-slate-900 dark:text-slate-100 truncate">Work Portfolio</h2>
              <span className="px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 text-[10px] font-bold shrink-0">
                {portfolio.length} Projects
              </span>
            </div>
            <p className="text-[11px] text-slate-500 truncate sm:whitespace-normal">Photos of completed installations and job sites.</p>
          </div>
      ...
      {/* 5. IDENTITY & KYC VERIFICATION (Padding: 15px / p-[15px]) */}
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-[15px] border border-slate-200 dark:border-slate-800 shadow-xs space-y-3.5">
        <div className="flex items-center justify-between gap-2.5 pb-2.5 border-b border-slate-100 dark:border-slate-800">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              <h2 className="font-black text-sm sm:text-base text-slate-900 dark:text-slate-100 truncate">Identity & Verification</h2>
              {isVerified ? (
            ...
            <p className="text-[11px] text-slate-500 truncate sm:whitespace-normal">Government ID check & biometric face liveness match.</p>
          </div>

          {isVerified ? (
            <span className="p-2 sm:px-3 sm:py-1.5 rounded-xl bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 font-extrabold text-xs border border-emerald-500/20 flex items-center gap-1.5 shrink-0">
              <ShieldCheck className="w-4 h-4 sm:w-3.5 sm:h-3.5 text-emerald-600 dark:text-emerald-400" />
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-[15px] border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <button
          ...
          className="px-3.5 py-2 rounded-xl bg-rose-50 hover:bg-rose-100 dark:bg-rose-950/40 dark:hover:bg-rose-900/50 text-rose-600 dark:text-rose-400 font-bold text-xs border border-rose-200 dark:border-rose-900/50 transition-colors cursor-pointer shrink-0 flex items-center justify-center gap-2 self-start sm:self-auto"
        >
